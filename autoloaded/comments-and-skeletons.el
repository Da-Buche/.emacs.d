...
(defun global-insert-file-title nil
  ...
  (let ((separator (concat comment-start comment-start " "))
    ...
    (save-excursion (insert "\n")
      ...
      (insert comment-start comment-start " A. Buchet - " (format-time-string "%B %Y")) (funcall indent-line-function) (insert "\n")
      (insert separator)                                                                (funcall indent-line-function) (insert "\n")
      (insert "\n\n\n;*/\n\n")
      )))

(defun global-insert-title (level char)
  "Insert a comment title using CHAR, size of the title depends on LEVEL"
